...
namespace FreeCourse.Services.Catalog.Services
{
    public class CourseService: ICourseService
    {
        ...
        public CourseService(IMapper mapper, IDatabaseSettings databaseSettings, Mas.IPublishEndpoint publishEndpoint)
        {
        ...
        {
            var result = await _courseCollection.DeleteOneAsync(d => d.Id == id);
